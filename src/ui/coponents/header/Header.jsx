...
import {
    ...
    useMediaQuery, Drawer, IconButton, Container,
} from '@mui/material'
...
const Header = () => {
    ...
    return (
        <>
            <AppBar position="static" sx={{ boxShadow: 'none', background: '#000', padding: '10px', }}>
                <Container fixed>
                    <Box display="flex">
                        <Box flexGrow="1">
                            <NavLink to="/">
                                <img src={require("../../assets/commons/logo.png")} alt="" className={classes.logoImg} />
                            </NavLink>
                        </Box>
                        {!isMobile && (
                            <Toolbar >
            ...
            >
                <Box sx={{ textAlign: 'center', }}>
                    ...
                    <br />
                    {Links.map((item, i) => (
                        <NavLink to={item.url} onClick={handleDrawer(false)}
                            className={classes.heading}
